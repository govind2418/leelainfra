...
export const PRODUCTS: Product[] = [
  {
    ...
    specs: [
      { label: "Size", value: "193 mm x 1375 mm" },
      { label: "Width", value: "193 mm" },
      { label: "Height", value: "1375 mm" },
      { label: "Thickness", value: "10 mm" },
      { label: "Surface Resistance", value: "AC4-32: Home and Office Use" },
      { label: "Locking System", value: "L2C" },
      { label: "Surface", value: "Register Emboss" },
      { label: "Pattern", value: "Wood" },
      { label: "Border", value: "Jointed" },
      { label: "Package", value: "6 Piece / 1,5923 m² / 14,35 kg" },
      { label: "Pallet", value: "60 Piece / 95,535 m²" },
    ],
